...
namespace EquipmentDomain
{
	...
	public static class SlaveLordCrafting
	{
		...
		public class SlaveLordItemContainer : ACustomItemContainer
		{
			...
			public static List<EquipmentSlotType> DisallowedSlots = new List<EquipmentSlotType> { EquipmentSlotType.Back, EquipmentSlotType.Body, EquipmentSlotType.Eye, EquipmentSlotType.Hand, EquipmentSlotType.Head, EquipmentSlotType.Offhand, EquipmentSlotType.Weapon };
			...
			public override List<EquipmentSlotType> GetDisallowedSlots()
			{
			...
			void GenerateItem()
			{
				...
				else GeneratedItem.ItemProperties.Clear();
            ...
            public override Equipment GetItem()
            {
                GenerateItem();
            ...
            public void ToXml(XmlElement xci, XmlDocument doc)
			{
			...
			public bool FromXml(XmlElement xci)
			{
				try
				{
					string[] baseitem = xci.GetElementsByTagName("BaseItem")[0].InnerText.Split('|');
					EquipmentSlotType slot = (EquipmentSlotType)Enum.Parse(typeof(EquipmentSlotType), baseitem[1]);
